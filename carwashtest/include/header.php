...
<div class="main-container d-flex">
  <div class="sidebar" id="sidenav">
      ...
      <ul class="list-unstyled px-2">
          <li class=""><a href="admin-dashboard.php" class="text-decoration-none d-block px-3 py-2"><i class="fa-solid fa-chart-line"></i> Dashboard</a></li>
          ...
          <li class=""><a href="announcement.php" class="text-decoration-none d-block px-3 py-2"><i class="fa-regular fa-calendar-check"></i> Announcement</a></li>
