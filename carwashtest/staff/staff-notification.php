            ...
            <div class="card-body">
                ...
                <div class="mt-3 d-flex">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="staff-appoint.php?apid=<?php echo htmlspecialchars($row['appointID']); ?>" class="btn btn-dark btn-sm">View</a>
                    </div>
        ...
        <div class="card w-75 mb-3">
            <div class="card-body">
                ...
                <div class="mt-3 d-flex">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="staff-appoint.php?apid=<?php echo htmlspecialchars($row1['appointID']); ?>" class="btn btn-dark btn-sm">View</a>
                    </div>
