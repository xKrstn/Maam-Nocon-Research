    ...
    <tbody>
        ...
        ?>
            <tr class="align-middle fs-6">
                ...
                &nbsp;
              <a href="admin-reply.php?cid=<?php echo htmlspecialchars($row['customerID']); ?>" class="btn btn-dark btn-sm">Message</a>&nbsp;
              <a href="usercomplete.php?id=<?php echo $row["appointID"]; ?>" class="btn btn-dark btn-sm">Done</a>&nbsp;
              <a onclick="return confirm('Are you sure you want to cancel this appointment?')" href="admin-cancel.php?aid=<?php echo $row["appointID"]; ?>" class="btn btn-dark btn-sm">Cancel</i></a>
                </td>
            </tr>
        <?php
        }
